...
export function CredentialsPanel({ personas }: { personas: PersonaOption[] }) {
  return (
    <div className="grid gap-12 lg:grid-cols-2">
      <div>
        <h2 id="issue" className="scroll-mt-6 text-subheading leading-subheading">Issue a credential</h2>
      ...
      <div>
        <h2 id="revoke" className="scroll-mt-6 text-subheading leading-subheading">Revoke a credential</h2>
        <p className="mt-1 max-w-[52ch] text-caption leading-caption text-label">
